...
#      and differences in predictive abilities for meat quality traits
#===================================================================

# 1. boot_fun: function to obtain the confidence intervals 
# input: x = vector of predictive abilities
...
# 2. calcSD: function taked from  https://github.com/schrauf/AccuracyComparer/ 

# The function give the confidence intervals and the statistical difference in predictive abilities
...
# 3. ff: function to compute the difference in predictive abilities between models with the
#       meat quality data 
